...
void* compute_mandelbrot(void *threadarg){
    ...
    int thread_min = data->thread_min;
    int thread_max = data->thread_max;
    ...
    for(i_y = thread_min; i_y < thread_max; i_y++){
...
int main(int argc, char *argv[]){
    ...
    for (int t = 0; t < num_threads; t++) {
        ...
        thread_data_array[t].thread_min = image_size/num_threads * t;
        thread_data_array[t].thread_max = image_size/num_threads * (t+1);
